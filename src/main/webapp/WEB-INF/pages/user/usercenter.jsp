        ...
        <nav class="sidebar">
            <ul class="nav">
                ...
                <li style="background:gray;">
                    <a href="${basePath}/page/user" title="Dashboard"
                    ...
                    <ul class="nav collapse ">
                        ...
                        <li>
                            <a href="/page/check_car">
                                <span class="item-text">我发布的古玩信息</span> </a>
                        </li>
                    </ul>
                    <!-- END SubMenu item-->
                </li>
...
<script>
    ...
    $("#edit").click(function () {
        if (status == 0) {
            ...
            init_name = $("#uname").html();
            init_sex = $("#usex").html();
            init_age = $("#uage").html();
            init_phone = $("#uphone").html();

            $("#uname").html("<input type=\"text\" id=\"nameInput\" class=\"form-control\" value=" + init_name + ">");
            $("#usex").html("<input type=\"text\" id=\"sexInput\" class=\"form-control\" value=" + init_sex + ">");
            $("#uage").html("<input type=\"text\" id=\"ageInput\" class=\"form-control\" value=" + init_age + ">");
            $("#uphone").html("<input type=\"text\" id=\"phoneInput\" class=\"form-control\" value=" + init_phone + ">");
            status = 1;
        }
        return false;
    });
    ...
    $("#save").click(function () {
        if (status == 1) {
            ...
            var usex = $("#sexInput").val();
            var uage = $("#ageInput").val();
            var uphone = $("#phoneInput").val();

            // alert(uname+":"+usex+":"+uage+":"+uphone)
            $("#uname").html(uname);
            $("#usex").html(usex);
            $("#uage").html(uage);
            $("#uphone").html(uphone);
            ...
            $.ajax({
                type: "POST",
                url: "../usercenter/saveuserinfo",
                data: {uname: uname, usex: usex, uage: uage, uphone: uphone},
                success:function () {
                    alert("修改成功");
                }
            });
    ...
    $("#cancel").click(function () {
        if (status == 1) {
            ...
            $("#uname").html(init_name);
            $("#usex").html(init_sex);
            $("#uage").html(init_age);
            $("#uphone").html(init_phone);
            status = 0
        }
        return false;
    });
