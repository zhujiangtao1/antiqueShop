         ...
         <section class="main-content">
            ...
            <div class="panel panel-default">
               ...
               <div class="table-responsive">
                  ...
                  <c:forEach items="${picFavAntiqueInfoVos}" var="item">
                     <tr>
                        <td>${item.fav.favid}</td>
                        ...
                        <td>${item.antiqueInfo.price}万</td>
                        <td>${item.antiqueInfo.uid}</td>
                        <td>${item.antiqueInfo.address}</td>
                        <td>${item.antiqueInfo.islocked}</td>
                        <td><a href="javascript:void(0);" onclick="del(${item.fav.favid})" >取消收藏</a></td>
                     </tr>
                  </c:forEach>
                     </tbody>
                  </table>
...
//                 location.reload();
      ...
      function addDiscuss(data, discussListDom) {
         ...
         for (var i = 0; i < data.length; i++) {
            ...
            message = "<td>"+data[i].fav.favid+"</td>"+
                    ...
                    "<td>"+data[i].antiqueInfo.uid+"</td>"+
                    "<td>"+data[i].antiqueInfo.islocked+"</td>"+
                    "<td>"+data[i].antiqueInfo.address+"</td>"+
                    "<td><a href='javascript:void(0);' id='cancel' onclick=del('"+data[i].fav.favid+"')  >删除</a></td>";
