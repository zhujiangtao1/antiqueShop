                  ...
                  <table id="table-id" class="table table-bordered table-hover">
                     ...
                     <c:forEach items="${picOrderInfoVos}" var="item">
                        <tr>
                           ...
                           <td><a href="javascript:void(0);"  id="check" onclick="ok(${item.order.orderId})">确认预约</a></td>
                        </tr>
                     </c:forEach>
                     </tbody>
                  </table>
      ...
      function addDiscuss(data, discussListDom) {
         ...
         for (var i = 0; i < data.length; i++) {
            ...
            message = "<td>"+data[i].order.orderId+"</td>"+
                    ...
                    "<td><a href='javascript:void(0);' id='cancel' onclick=ok('"+data[i].order.orderId+"')  >确认预约</a></td>";
