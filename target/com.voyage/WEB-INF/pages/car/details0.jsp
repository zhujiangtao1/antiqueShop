            ...
            <div class="single">
                ...
                <div class="infor-main service-open">
                    <div class="product-detail" id="page-slide" data-group-count="4">
                        ...
                        <div>
                            <img alt="111" src="${antInfo.pic_url}" style="width: 700px;height: 450px;">
                        </div>
                    ...
                    <div class="product-textbox">
                        <div class="titlebox">
                            <p>  ${antInfo.antiqueInfo.category}：${antInfo.antiqueInfo.antique_name} </p>
                            <span class="labels">认证精品店</span>
                        </div>

                        <ul class="assort clearfix">
                            <li class="one"><span>${antInfo.antiqueInfo.years}</span>年代</li>
                            <li class="two"><span>${antInfo.antiqueInfo.size}</span>尺寸</li>
                            <li class="three"><span>${antInfo.antiqueInfo.antique_damage}</span>损坏程度</li>
                            <li class="last"><span>${antInfo.antiqueInfo.address}</span>地址</li>
                        </ul>

                        <div class="pricebox js-disprice">
                            <i class="ico-type">藏主报价：</i>
                            <span class="pricestype">${antInfo.antiqueInfo.price}  <span class="f14">万</span></span>
                        </div>
                        ...
                        <div class="btnbox clearfix">
                            <a id="order" rel="nofollow" href="javascript:void(0)" class="orgbtn js-apt">预约看宝</a>

                            </a>
                            <a id="collect" rel="nofollow" href="javascript:void(0)" class="greenbtn js-bargain">添加收藏</a>
                ...
                <div class="detailcontent">
                    <table border="1" class="table1">
                        <thead>
                        <tr>
                            <th align="center" colspan="2">古玩背景</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            <td>${antInfo.antiqueInfo.jian}</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="comment-collection">
                    <div class="comment-item ng-scope">
                        <div class="comment-main-content">
                            ...
                            <em class="ng-binding">${item.comment_test}</em>
                        </div>
                        <div class="comment-function">
                            <em class="time ng-biinding">${item.commentTime}</em>
                        </div>
                    </div>
                </div>
            </c:forEach>
            <form id="addCommentForm" class="form-horizontal" >
                <div class="comment-add row">
                    <div class="input-field col s12">
                        ...
                        <input id="antId" name="antid" value="${antInfo.antiqueInfo.antId}" type="hidden"/>

                        <input id="commentbox" type="text" name="comment_test" class="validate ng-pristine ng-untouched ng-valid ng-empty"/>
...
//         console(user);
        $("#order").click(function(){
            ...
            $.ajax({
                type:"post",
                url:"../order/create",
                data:{id:${antInfo.antiqueInfo.antId}},
...
//                        alert(JSON.stringify(data));
        ...
        $("#collect").click(function(){
            ...
            $.ajax({
                type:"post",
                url:"../fav/save",
                data:{antId:${antInfo.antiqueInfo.antId}},
